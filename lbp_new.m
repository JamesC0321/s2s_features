...
function result = lbp(varargin) %  lbp_new(structdis,1,8,MAPPING,'x')  
% Version 0.3  LBP返回图像的局部二进制模式图像或LBP直方图。
% Authors: Marko Heikkil and Timo Ahonen

% Check number of input arguments.
narginchk(1,5); % 验证当前执行的函数调用中的输入参数数目

image=varargin{1}; %structdis
